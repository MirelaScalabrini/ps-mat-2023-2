import jwt from 'jsonwebtoken' 
 ...
 // As rotas que eventualmente não necessitarem de autenticação devem ser colocadas no vetor abaixo
 const  bypassRoutes = [
...
export default function (req, res, next) {
    ...
    // Verifique se a rota da vez é desprotegida
    for(let route of bypassRoutes) {
        // Se a rota estiver no vetor bypassRoutes, deixa continuar sem autenticação
        ...
        jwt.verify(token, process.env.TOKEN_SECRET, (error, decoded) => {
            ...
            /*
             Se chegarmos até aqui, o token está OK e temos as informações do usuário logado no parâmetro 'decoded'. Vamos guardar isso
